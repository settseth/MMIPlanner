angular.module('MMIPlanner').controller('ClubsController', function($scope, $sce) {
    $scope.clubs = [
        {
            nom: "Club VR",
        ...
        {
            nom: "Club Cinéma",
            description: "Dirigé(e)s par Vincent Wable et Kawthar Mekouar.",
        ...
        },
        {
            ...
            bio: $sce.trustAsHtml("Le Club Sport est dirigé par Julien Ramio et Carole Seville, professeurs de sport passionnés par la santé et le bien-être physique. Ils vous accompagneront à travers diverses activités physiques, que ce soit pour un match de basket, une balade à pied à Vélizy, ou même des astuces pour lutter contre le stress.<br><br> ma, vous guidera à travers l'histoire du cinéma et l'art de la narration visuelle.<br><br>Que vous soyez amateur ou curieux, rejoignez le club Cinéma pour explorer les bases du tournage, des angles de caméra à la composition des scènes. Un club pour tous les passionnés de cinéma !"),
            expanded: false
        },
        {
            nom: "Club Jeux Vidéo",
